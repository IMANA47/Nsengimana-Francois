                            ...
                            <div class="contact-list">
                                <div class="contact-item mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="text-white contact-text">{{ config('portfolio.profile.email') }}</span>
                                    </div>
                                </div>
                                <div class="contact-item mb-3">
                                    <div class="d-flex align-items-center">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="message" name="message" class="form-control" rows="5" placeholder="Votre message" required>{{ old('message') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
