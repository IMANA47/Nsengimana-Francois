                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="mb-3 d-flex align-items-center">
                                ...
                                <span class="text-white"><?php echo e(config('portfolio.profile.email')); ?></span>
                            </li>
                            <li class="mb-3 d-flex align-items-center">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="<?php echo e(route('contact.store')); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="message" name="message" class="form-control" rows="4" placeholder="Votre message" required><?php echo e(old('message')); ?></textarea>
                            </div>
